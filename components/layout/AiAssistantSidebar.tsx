    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <span className="text-[10px] text-stone-400 dark:text-stone-500">Z can make mistakes. Check important info.</span>
        </div>
      </div>
    </div>
  );
    ...
    <div className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
      ...
      {!isUser && (
        <div className="flex items-center gap-1 mt-1 ml-1">
          ...
          <span
            className="text-[10px] font-semibold bg-clip-text text-transparent animate-[shimmer_3s_linear_infinite] bg-[length:200%_100%]"
            style={{
