...
const STATUS_CONFIG = {
  ...
  // Company statuses
  active: { label: 'Active', className: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-950 dark:text-emerald-400' },
  inactive: { label: 'Inactive', className: 'bg-stone-100 text-stone-600 dark:bg-stone-800 dark:text-stone-400' },
  pending: { label: 'Pending', className: 'bg-amber-100 text-amber-800 dark:bg-amber-950 dark:text-amber-400' },
} as const
